  ...
  */
  writeFlightParams(flightParams) {
    ...
    */
    ...
    /**
    * Convenience method for writing the shoot command
    * @return {undefined}
    */
    writeShoot() {
      const buffer = new Buffer(19);
      buffer.fill(0);
      buffer.writeInt16LE(4, 0);
      buffer.writeInt16LE(++this.steps[COMMAND_KEY], 1);
      buffer.writeInt16LE(2, 2);
      buffer.writeInt16LE(16, 3);
      buffer.writeInt16LE(2, 4);
      buffer.writeInt16LE(0, 5);
      ...
      this.write(COMMAND_KEY, buffer);
      Logger.info('Shoot command called');
    }
    ...
    writeClose() {
      ...
      buffer.writeInt16LE(0, 5);
      buffer.writeInt16LE(0, 6);
      buffer.writeInt16LE(1, 7);
      buffer.writeFloatLE(0, 8);
      this.write(COMMAND_KEY, buffer);
      Logger.info('Close command called');
    }
